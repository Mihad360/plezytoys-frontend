      ...
      <main className="flex-1 overflow-auto p-8">
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h2 className="text-[#1a2642] text-[24px] font-bold mb-1">Create task</h2>
              <p className="text-gray-500 text-[14px]">Assignment, approval and evidence are stored on each task occurrence.</p>
            </div>
            <Link href="/company-admin/tasks" className="text-gray-500 hover:text-[#1a2642] text-[14px] font-medium">
              Cancel
            </Link>
          </div>
